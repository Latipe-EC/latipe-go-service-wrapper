...
func NewServer(
	...
	app.Get("/api/v1/health", basicauth.New(basicAuthConfig), adaptor.HTTPHandlerFunc(h.HandlerFunc))
	...
	//swagger
	app.Get("/api/v1/swagger/*", basicauth.New(basicAuthConfig), swagger.HandlerDefault) // default
